...
public class RunnerMap extends Mapper<String, String, IntWritable, Text> {
	...
	public void setup(Context context) throws IOException{
		...
		System.out.println("-------------------------------------");
		this.localProgram = local[0].toUri().getPath();
	}
	...
	public void map(String key, String value, Context context) throws IOException,
		...
		String execCommand = "/home/hadoop/jdk1.7.0_25/bin/java -jar " + this.localProgram + File.separator + execName + " " + "markers=" + this.localProgram + File.separator + "hapmap.markers" + " " +  "phased=" + this.localProgram + File.separator + "hapmap.phased.bgl " + " " +  "unphased=" + this.localProgram + File.separator + "hapmap.unphased.bgl" + " " +  "missing=?" + " " + "out="+workingDir + File.separator+"example";
