...
public class RunnerMap extends Mapper<String, String, IntWritable, Text> {
	...
	public void map(String key, String value, Context context) throws IOException,
		...
		execCommand = "/home/hadoop/jdk1.7.0_25/bin/java -jar " + this.localProgram + File.separator + execName + " " + execCommand;
		...
		fs.copyFromLocalFile(new Path(outFile + ".vcf.gz"),outputFileName);
