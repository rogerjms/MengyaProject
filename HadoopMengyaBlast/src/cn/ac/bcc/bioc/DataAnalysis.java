...
public class DataAnalysis {
	...
	public static void main(String[] args) throws Exception {
		...
		//GenericOptionsParser enable the standard command line arguments into job configuration file
		String[] otherArgs = new GenericOptionsParser(conf, args)
				.getRemainingArgs();
		if (otherArgs.length < 8) {
			System.err
					.println("Usage: DataAnalysis <Executable and Database Archive on HDFS> <Executable> <Working_Dir> <Database dir under archive> <Database name> <HDFS_Input_dir> <HDFS_Output_dir> <Cmd_args>");
			System.exit(2);
		}
